/*
https://github.com/Vages/min-cost-flow/blob/master/source/index.ts 
The code below is heavily inspired by the code below, just some changes made to fit my 
use case and because the library hasnt been supported in past 5 years

See the test cases for examples:
https://github.com/Vages/min-cost-flow/blob/master/test/index.test.ts
*/
...
/**
 * Uses the logic  <https://cp-algorithms.com/graph/min_cost_flow.html>
